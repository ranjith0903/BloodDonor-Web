  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/profile" element={!user?<LoginPage/>:<ProfilePage />}></Route>
        <Route
          path="/login"
        ...
        <Route path="/findStats" element={user?.role==="admin"?<FindStats />:<Navigate to="/" />}></Route>
       
        <Route path="/registerCampaign" element={<RegisterCampaign />} />

        <Route path="/admin" element={user?.role==="admin"?<AdminPage />:<Navigate to="/" />} />
        <Route path="/deleteuser" element={user?.role==="admin"?<DeleteUser />:<Navigate to="/" />} />
        <Route path="/deletecampaign" element={user?.role==="admin"?<DeleteCampaign />:<Navigate to="/" />} />
        <Route path="/bloodstats" element={user?.role==="admin"?<BloodStatsPage/>:<Navigate to="/" />} />
